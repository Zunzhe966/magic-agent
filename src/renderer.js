...
function viewConsole() {
  ...
  return `
    <div class="card">
      ...
      <div class="grid cols-4">
        <div class="form-row"><label>名称</label><input id="srv-name" class="input" placeholder="VPS 服务器" /></div>
        <div class="form-row"><label>地址</label><input id="srv-host" class="input" placeholder="1.1.1.1" /></div>
